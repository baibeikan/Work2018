...
//
	...
	CString get_AllowFullScreenInteractive()
	{
		CString result;
		InvokeHelper(0x1f5, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	void put_AllowFullScreenInteractive(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
	...
	CString get_BrowserZoom()
	{
		CString result;
		InvokeHelper(0x1f7, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	void put_BrowserZoom(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
